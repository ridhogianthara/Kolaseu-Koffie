		...
		<section class="nav_bar">
			<div class="container">
					<ul>
						...
						<li><a href="category.php"><i class='fas fa-newspaper' style='color: white'></i> KOLASEU KATEGORI</a></li>
						<li><a href="food.php"><i class='fas fa-boxes' style='color: white'></i> MENU</a></li>
						<li><a href="order.php"><i class='fas fa-clipboard-list' style='color: white'></i> ORDER</a></li>
						<li><a href="qr_generator.php"><i class='fas fa-qrcode' style='color: white'></i> QR GENERATOR</a></li>
